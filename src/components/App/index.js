...
export default function App(props) {
    ...
    return (
        <main id='home' className={modal ? 'stop-scroll' : ''}>
            {modal ? <Modal images={images} resetImages={() => setImages([])} closeModal={() => setModal(false)} /> : null}
            <div className="main-container">
                ...
                <Gallery images={images} setImages={setImages} modal={modal} setModal={() => setModal(true)} />
